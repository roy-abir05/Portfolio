...
const socials = [
  ...
  {
    name: "Codeforces",
    icon: <Codeforces className="w-5 h-5" />,
    href: "https://codeforces.com/profile/roy_abir05",
  },
  {
    name: "CodeChef",
    icon: <CodeChef className="w-5 h-5" />,
...
function Codeforces(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      fill="currentColor"
      viewBox="0 0 24 24"
...
function CodeChef(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      fill="currentColor"
      viewBox="0 0 24 24"
